...
- Remove "New" marker from link to guides
...
- Display navbar below page title on smaller screen sizes
...
- Allow user to hide visited / unvisited filters

## [1.11.4] - 2025-10-28

### Fixed

- Fix bug where clicking "Show filters" triggers infinite re-toggles of filter groups

## [1.11.3] - 2025-06-30

### Updated

- Allow user to toggle option filters by clicking on group header
